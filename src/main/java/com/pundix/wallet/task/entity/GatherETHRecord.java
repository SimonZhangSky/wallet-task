...
@Entity
@Table(name = "gather_eth_record")
@NoArgsConstructor
@AllArgsConstructor
@Data
public class GatherETHRecord implements Serializable {
    ...
    @Column(name = "user_amount_wei", nullable = false, columnDefinition = "bigint COMMENT '用户归集金额Wei'")
    private BigInteger userAmountWei;

    @Column(name = "user_amount_ether", nullable = false, columnDefinition = "decimal(20, 10) COMMENT '用户归集金额Ether'")
    private BigDecimal userAmountEther;

    @Column(name = "gather_amount_wei", nullable = false, columnDefinition = "bigint COMMENT '实际归集金额Wei'")
    private BigInteger gatherAmountWei;

    @Column(name = "gather_amount_ether", nullable = false, columnDefinition = "decimal(20, 10) COMMENT '实际归集金额Ether'")
